          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "남음",
                  style: EasierDodamStyles.label2.copyWith(fontSize: 12.0),
                ),
              ],
            ),
            const SizedBox(height: 12),
            Row(
              ...
              children: [
                Row(
                  children: [
                    Text("시작 ", style: EasierDodamStyles.label2),
                    Text(formatDateWithDay(startAt),
                        style: EasierDodamStyles.label2),
                  ],
                ),
                Row(
                  children: [
                    Text("복귀 ", style: EasierDodamStyles.label2),
                    Text(formatDateWithDay(endAt),
                        style: EasierDodamStyles.label2),
                  ],
                ),
              ],
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text("시작 ", style: EasierDodamStyles.body2),
                        Text(formatDateWithDay(startAt),
                            style: EasierDodamStyles.body2),
                        const Spacer(),
                        Text("복귀 ", style: EasierDodamStyles.body2),
                        Text(formatDateWithDay(endAt),
                            style: EasierDodamStyles.body2),
                      ],
                    )
